...
Ce document Rmarkdown (R + Markdown) propose une approche des solutions web3D *open source* pour la gestion, la visualisation et la navigation multi-scalaire dans des modèles 3D. Les données sources sont enregistrées dans deux *repository* GitHub:
  ...
  + [zoometh/3DHOP](https://github.com/zoometh/3DHOP) où sont entreposés les données 3D. C'est un *fork* de 3DHOP (v. [ci-dessous](#D3HOP)) et une pile logicielle LAMP (Linux, Apache, MySQL, PHP/Perl/Python)
...
#### Micro-topographies{#anal.scale.micro}
...
Le package [geodiv](https://rdrr.io/cran/geodiv/) offre plusieurs méthodes de calcul de la surface `xyz`, notamment:
