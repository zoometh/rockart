...
abstract: "A web multi-paradigm and multi-scalar presentation of rock-art data and 3D management with open-source softwares (MicMac, GitHub, 3DHOP, R, JavaScript, etc.) and commercial software (Photoscan) within the frame of Linked-Open data (LOD) and Web3D" 
author: "Thomas Huet"
# date: "4/26/2021"
output:
  html_document:
...
Nous présentons ci-dessous, un essai de FAIRisation des données liées aux graphies anciennes (art rupestre, hiéroglyphes) en nous focalisant sur la cartogaphie et la 3D. Les données sont enregistrées dans deux *repository* GitHub: [zoometh/3DHOP](https://github.com/zoometh/3DHOP) qui est un *fork* de 3DHOP et où sont entreposés les données 3D, et [zoometh/rockart](https://github.com/zoometh/rockart) pour le reste des données. Ici, nous prenons ces deux (2) sites en exemple:
...
Bego <- c("Bego", 7.4380446386350165, 44.07579327562306)
...
Les liens entre ces données et leurs identifiants [KIU](http://sith.huma-num.fr/karnak/) -- qui sont égalment des URL-- sont générés par concatenation
