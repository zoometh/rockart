---
title: "**Art rupestre** une approche <br> multi-paradigmes et <br> multi-scalaire dans le contexte <br> de la Science ouverte"
abstract: "A web multi-paradigm and multi-scalar presentation of rock-art data and 3D management with open-source softwares (GitHub, 3DHOP, R) and commercial software (Photoscan)" 
author: "Thomas Huet"
# date: "4/26/2021"
output:
  html_document:
...
n.models <- length(D3.models)
```

Actuellement, il existe `r n.models` modèles 3D: `r D3.models`.

# Cartographie

Nous lions les URL des roches gravées modélisées en 3D par jointure sur leur identifiant (e.g., 7_1_8) dans la table des roches -- pour les ouvrir directement à partir de la carte *Leaflet* --, et nous attribuons à ces roches une icône personnalisée (icône '3DHOP', en bleu)
